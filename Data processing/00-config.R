...
wd_path <- c("/Users/sophiedehont/Library/CloudStorage/OneDrive-TUEindhoven/Documents/ALMP-LTU-thesis")
setwd(wd_path)
...
data_path_raw <- file.path(wd_path, "Datasets", "Swiss data", "1203_ALMP_Data_E_v1.0.0.csv")

data_path_pre <- file.path(wd_path, "Datasets", "1203_ALMP.csv")

data_path_effects <- file.path(wd_path, "Datasets", "1203_ALMP_effects.csv")

data_path_risk <- file.path(wd_path, "Datasets", "1203_ALMP_effects_riskFemale001.csv")

data_path_sim <- file.path(wd_path, "Datasets", "1203_ALM_simulation_results.csv")
